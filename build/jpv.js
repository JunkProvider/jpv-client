...
var JPVForm;
(function (JPVForm) {
    var FieldLabelIcon = (function (_super) {
        __extends(FieldLabelIcon, _super);
        function FieldLabelIcon() {
            _super.call(this, document.createElement("img"));
        }
        Object.defineProperty(FieldLabelIcon.prototype, "htmlElement", {
            get: function () { return this._htmlElement; },
            enumerable: true,
            configurable: true
        });
        FieldLabelIcon.prototype.setState = function (state) {
            this.htmlElement.src = state.iconSrc;
            this.htmlElement.title = state.title;
        };
        FieldLabelIcon.prototype.setDisplayed = function (displayed) {
            this.htmlElement.style.display = displayed ? "" : "none";
        };
        return FieldLabelIcon;
    })(JPV.View.View);
    var FieldLabel = (function (_super) {
        __extends(FieldLabel, _super);
        function FieldLabel(label) {
            _super.call(this, document.createElement("div"));
            this.classes.add("form-field-label");
            this.append(this.span = document.createElement("span"));
            this.span.textContent = label;
            this.append(this.icon = new FieldLabelIcon());
        }
        FieldLabel.prototype.setValidity = function (validity) {
            this.icon.setState(validity);
        };
        FieldLabel.prototype.setIconDisabled = function (disabled) {
            this.icon.setDisplayed(!disabled);
        };
        return FieldLabel;
    })(JPV.View.View);
    JPVForm.FieldLabel = FieldLabel;
})(JPVForm || (JPVForm = {}));
/// <reference path="FieldLabel.ts" />
var JPVForm;
(function (JPVForm) {
    var FieldRow = (function (_super) {
        ...
        function FieldRow(field, label) {
            _super.call(this, document.createElement("div"));
            this.classes.add("form-field-row");
            this.append(this.label = new JPVForm.FieldLabel(label));
            this.append(this._field = field);
            field.input.stateChangedEvent.add(this, this.onInputValidityChanged);
            this.label.setValidity(field.input.state);
        }
        Object.defineProperty(FieldRow.prototype, "field", {
            get: function () { return this._field; },
            enumerable: true,
            configurable: true
        });
        FieldRow.prototype.onInputValidityChanged = function (input, validity) {
            this.label.setValidity(validity);
        };
        FieldRow.prototype.setIconDisabled = function (disabled) {
            this.label.setIconDisabled(disabled);
        };
        return FieldRow;
    })(JPV.View.View);
    JPVForm.FieldRow = FieldRow;
})(JPVForm || (JPVForm = {}));
var JPVForm;
(function (JPVForm) {
    var InputBase = (function (_super) {
        __extends(InputBase, _super);
        function InputBase(htmlElement) {
            _super.call(this, htmlElement);
            this.validationChangedEvent = new JPV.Event.Event();
            this.stateChangedEvent = new JPV.Event.Event();
            this.valueChangedEvent = new JPV.Event.Event();
            this.required = false;
            this._validationChain = null;
            this.validationProgress = null;
            this._state = JPVForm.InputState.EMPTY_AND_REQUIRED;
            this.classes.add("form-field-input");
            this.classes.add(this.state.cssClass);
            this._validationChain = new JPV.Validation.ValidationChain();
        }
        Object.defineProperty(InputBase.prototype, "validationChain", {
            get: function () { return this._validationChain; },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(InputBase.prototype, "state", {
            get: function () { return this._state; },
            enumerable: true,
            configurable: true
        });
        InputBase.prototype.getValidityItems = function () {
            return this.validationChain.items;
        };
        InputBase.prototype.isRequired = function () {
            return this.required;
        };
        InputBase.prototype.setRequired = function (required) {
            this.required = required;
            this.validate();
        };
        InputBase.prototype.validate = function () {
            var _this = this;
            this.setState(JPVForm.InputState.INVALID);
            this.doValidation(function () { return _this.updateState(); });
        };
        InputBase.prototype.doValidation = function (callback) {
            if (this.validationProgress != null) {
                this.validationProgress.stop();
                this.validationProgress = null;
            }
            var value = this.getValue();
            var empty = this.isEmpty();
            var validationState = new JPV.Validation.ValidationState(value);
            if (empty)
                validationState.interrupted = true;
            if (this.validationChain != null) {
                this.validationProgress = new JPV.Validation.ValidationProgress(this.validationChain.items, callback);
                this.validationProgress.start(validationState);
            }
            else {
                callback();
            }
        };
        InputBase.prototype.updateState = function () {
            if (this.isEmpty()) {
                this.setState(this.required ? JPVForm.InputState.EMPTY_AND_REQUIRED : JPVForm.InputState.EMPTY_AND_OPTIONAL);
                return;
            }
            var filtered = false;
            if (this.validationChain != null) {
                for (var _i = 0, _a = this.getValidityItems(); _i < _a.length; _i++) {
                    var item = _a[_i];
                    if (!item.state.valid) {
                        this.setState(JPVForm.InputState.INVALID);
                        return;
                    }
                    if (item.state == JPV.Validation.ValidityItemState.WILL_FILTER) {
                        filtered = true;
                    }
                }
            }
            this.setState(filtered ? JPVForm.InputState.WILL_BE_FILTERED : JPVForm.InputState.VALID);
        };
        InputBase.prototype.setState = function (state) {
            if (this.state == state)
                return;
            this.classes.remove(this.state.cssClass);
            this.classes.add(state.cssClass);
            this._state = state;
            this.stateChangedEvent.trigger(this, state);
        };
        InputBase.prototype.onValueChanged = function () {
            this.valueChangedEvent.trigger(this, this.getValue());
            this.validate();
        };
        return InputBase;
    })(JPV.View.View);
    JPVForm.InputBase = InputBase;
})(JPVForm || (JPVForm = {}));
    ...
    (function (Input) {
        var StringField = (function (_super) {
            ...
            function StringField() {
                ...
                this.stringValidationProgress = null;
                this.characters = null;
                this.lastStringValue = "";
                this.htmlElement.type = "text";
                this.htmlElement.oninput = function () { return _this.onValueChanged(); };
            }
            Object.defineProperty(StringField.prototype, "htmlElement", {
                get: function () { return this._htmlElement; },
                enumerable: true,
                configurable: true
            });
            StringField.prototype.getValidityItems = function () {
                var items = [];
                if (this.stringValidationChain != null)
                    items = items.concat(this.stringValidationChain.items);
                if (this.validationChain != null)
                    items = items.concat(this.validationChain.items);
                return items;
            };
            StringField.prototype.isEmpty = function () {
                return this.getStringValue() == "";
            };
            StringField.prototype.doValidation = function (callback) {
                var _this = this;
                this.doStringValidation(function (validationState) {
                    _this.doGenericValidation(validationState, function () {
                        callback();
                    });
                });
            };
            StringField.prototype.doStringValidation = function (callback) {
                if (this.stringValidationProgress != null) {
                    this.stringValidationProgress.stop();
                    this.stringValidationProgress = null;
                }
                ...
                if (empty)
                    validationState.interrupted = true;
                if (this.stringValidationChain != null) {
                    this.stringValidationProgress = new JPV.Validation.ValidationProgress(this.stringValidationChain.items, function (validationState) { return callback(validationState); });
                    this.stringValidationProgress.start(validationState);
                }
                else {
                    callback(validationState);
                }
            };
            StringField.prototype.doGenericValidation = function (stringValidationState, callback) {
                if (this.validationProgress != null) {
                    this.validationProgress.stop();
                    this.validationProgress = null;
                }
                var validationState = new JPV.Validation.ValidationState(this.getValue());
                validationState.valid = stringValidationState.valid;
                validationState.interrupted = stringValidationState.interrupted;
                if (this.validationChain != null) {
                    this.validationProgress = new JPV.Validation.ValidationProgress(this.validationChain.items, function (validationState) { return callback(validationState); });
                    this.validationProgress.start(validationState);
                }
                else {
                    callback(validationState);
            ...
            StringField.prototype.onValueChanged = function () {
                if (this.characters != null) {
                    var regExp = new RegExp("[^" + this.characters + "]+", "g");
                    var value = this.getStringValue();
            ...
            StringField.prototype.getStringValue = function () {
                return this.htmlElement.value;
            };
            StringField.prototype.setStringValue = function (stringValue) {
                this.htmlElement.value = stringValue;
                this.lastStringValue = stringValue;
            };
            return StringField;
        })(JPVForm.InputBase);
        Input.StringField = StringField;
    })(Input = JPVForm.Input || (JPVForm.Input = {}));
})(JPVForm || (JPVForm = {}));
/// <reference path="StringField.ts" />
var JPVForm;
(function (JPVForm) {
    var Input;
    (function (Input) {
        var NumberField = (function (_super) {
            ...
            function NumberField(allowFloat, allowNegative) {
                if (allowFloat === void 0) { allowFloat = true; }
                if (allowNegative === void 0) { allowNegative = true; }
                _super.call(this);
                var pattern = "[0-9]+";
                var patternInfo = "Must be a valid integer.";
                var characters = "0-9";
                if (allowFloat) {
                    pattern += "(\.[0-9]+)?";
                    patternInfo = "Must be a valid number.";
                    characters += "\.";
                }
                if (allowNegative) {
                    pattern = "-?" + pattern;
                ...
                pattern = "^(" + pattern + ")$";
                this.stringValidationChain = new JPV.Validation.ValidationChain([
                    new JPV.Validation.SynchroneFilterItem(new JPV.Validation.Filter.StringTrim(null)),
                    new JPV.Validation.SynchroneValidatorItem(new JPV.Validation.Validator.StringPattern(pattern, true, patternInfo))
                ]);
            ...
            NumberField.prototype.setValue = function (value) {
                this.setStringValue(value != null ? value.toString() : "");
                this.onValueChanged();
            };
            return NumberField;
        })(Input.StringField);
...
(function (JPVForm) {
    ...
    (function (Tooltip) {
        var TooltipItem = (function (_super) {
            ...
            function TooltipItem(validityItem) {
                _super.call(this, document.createElement("li"));
                this.state = null;
                this.validityItem = validityItem;
                this.classes.add("form-tooltip-item");
                if (validityItem.text != null) {
                    this.htmlElement.textContent = validityItem.text;
                }
                else {
                    this.htmlElement.style.display = "none";
                }
                validityItem.stateChangedEvent.add(this, this.onValidityItemStateChanged);
                this.setState(validityItem.state);
            }
            TooltipItem.prototype.onValidityItemStateChanged = function (validityItem) {
                this.setState(validityItem.state);
            };
            TooltipItem.prototype.setState = function (state) {
                if (state == this.state)
                    return;
                if (this.state != null)
                    this.classes.remove(this.state.css);
                if (state != null)
                    this.classes.add(state.css);
                this.state = state;
            };
            return TooltipItem;
        })(JPV.View.View);
        Tooltip.TooltipItem = TooltipItem;
    })(Tooltip = JPVForm.Tooltip || (JPVForm.Tooltip = {}));
})(JPVForm || (JPVForm = {}));
var JPVFormMVC;
(function (JPVFormMVC) {
    var Model;
    (function (Model) {
        ...
        (function (Value) {
            var ValueModel = (function () {
                function ValueModel() {
                    this.filteredValueChangedEvent = new JPV.Event.Event();
                    this.unfilteredValueChangedEvent = new JPV.Event.Event();
                    this.filteredValue = null;
                    this.unfilteredValue = null;
                }
                ValueModel.prototype.getFilteredValue = function () {
                    return this.filteredValue;
                };
                ValueModel.prototype.setFilteredValue = function (filteredValue) {
                    if (filteredValue == this.filteredValue)
                        return;
                    this.filteredValue = filteredValue;
                    this.filteredValueChangedEvent.trigger(this, null);
                };
                ValueModel.prototype.getUnfilteredValue = function () {
                    return this.unfilteredValue;
                };
                ValueModel.prototype.setUnfilteredValue = function (unfilteredValue) {
                    if (unfilteredValue == this.unfilteredValue)
                        return;
                    this.unfilteredValue = unfilteredValue;
                    this.unfilteredValueChangedEvent.trigger(this, null);
                };
                return ValueModel;
            })();
            Value.ValueModel = ValueModel;
        })(Value = Model.Value || (Model.Value = {}));
    })(Model = JPVFormMVC.Model || (JPVFormMVC.Model = {}));
})(JPVFormMVC || (JPVFormMVC = {}));
/// <reference path="../InputBase.ts" />
var JPVForm;
(function (JPVForm) {
    var Input;
    (function (Input) {
        var TextField = (function (_super) {
            ...
            Object.defineProperty(TextField.prototype, "htmlElement", {
                get: function () { return this._htmlElement; },
                enumerable: true,
                configurable: true
            });
...
var Test;
(function (Test) {
    var FieldTest = (function () {
        function FieldTest(contentContainer) {
            this.contantContainer = contentContainer;
        }
        FieldTest.prototype.run = function () {
            var valueModel = new JPVFormMVC.Model.Value.TextBasedValueModel();
            valueModel.userValueChangedEvent.add(this, function () {
                console.log(valueModel.getUserValue());
            });
            var view = new JPVFormMVC.View.Input("text", valueModel);
            this.contantContainer.appendChild(view.htmlElement);
            valueModel.setUserValue("asdf");
        };
        return FieldTest;
    })();
    Test.FieldTest = FieldTest;
})(Test || (Test = {}));
    ...
    (function (Input) {
        var Checkbox = (function (_super) {
            ...
            function Checkbox() {
                ...
                this.htmlElement.onchange = function () { return _this.onValueChanged(); };
            }
...
(function (JPVForm) {
    var InputCollection = (function () {
        function InputCollection() {
            this.validityChangedEvent = new JPV.Event.Event();
            this.inputs = [];
            this.valid = true;
        }
        InputCollection.prototype.addInput = function (input) {
            this.inputs.push(input);
            input.stateChangedEvent.add(this, this.validate);
            input.validate();
            this.validate();
        };
        ...
        InputCollection.prototype.validate = function () {
            var valid = true;
        ...
        InputCollection.prototype.setValid = function (valid) {
            if (valid == this.valid)
                return;
            this.valid = valid;
            this.validityChangedEvent.trigger(this, valid);
        };
        return InputCollection;
    })();
    JPVForm.InputCollection = InputCollection;
})(JPVForm || (JPVForm = {}));
var JPVForm;
(function (JPVForm) {
    var Tooltip;
    (function (Tooltip) {
        var TooltipDescription = (function (_super) {
            __extends(TooltipDescription, _super);
            function TooltipDescription(text) {
                _super.call(this, document.createElement("div"));
                this.classes.add("form-tooltip-description");
                if (text != null) {
...
(function (JPVFormNew) {
    var View;
    (function (View) {
        var StringFieldController = (function () {
            function StringFieldController(view) {
                this.view = view;
            }
            return StringFieldController;
        })();
        View.StringFieldController = StringFieldController;
    })(View = JPVFormNew.View || (JPVFormNew.View = {}));
})(JPVFormNew || (JPVFormNew = {}));
var JPV;
(function (JPV) {
    var View;
    (function (View) {
...
(function (JPVForm) {
    var Input;
    (function (Input) {
        var EMailAddressField = (function (_super) {
            __extends(EMailAddressField, _super);
            function EMailAddressField() {
                _super.call(this);
                this.validationChain.addSynchroneFilter(new JPV.Validation.Filter.StringTrim("Will be trimmed."));
                this.validationChain.addSynchroneValidator(new JPV.Validation.Validator.EMailAddressPattern());
                this.validationChain.addSynchroneValidator(new JPV.Validation.Validator.EMailAddressLength());
                this.htmlElement.maxLength = JPV.Validation.Validator.EMailAddressLength.MAX_LENGTH;
            }
            return EMailAddressField;
        })(Input.TextField);
        Input.EMailAddressField = EMailAddressField;
    })(Input = JPVForm.Input || (JPVForm.Input = {}));
})(JPVForm || (JPVForm = {}));
var JPVForm;
(function (JPVForm) {
    var InputState = (function () {
        function InputState(valid, cssClass, title) {
            this._valid = valid;
            this._cssClass = cssClass;
            this._title = title;
            this._iconSrc = "images/" + cssClass + ".png";
        }
        Object.defineProperty(InputState.prototype, "valid", {
            get: function () { return this._valid; },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(InputState.prototype, "cssClass", {
            get: function () { return this._cssClass; },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(InputState.prototype, "title", {
            get: function () { return this._title; },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(InputState.prototype, "iconSrc", {
            get: function () { return this._iconSrc; },
            enumerable: true,
            configurable: true
        });
        InputState.VALID = new InputState(true, "valid", "Valid");
        InputState.WILL_BE_FILTERED = new InputState(true, "will-be-filtered", "Will be filtered");
        InputState.INVALID = new InputState(false, "invalid", "Invalid");
        InputState.EMPTY_AND_REQUIRED = new InputState(false, "empty-and-required", "Required");
        InputState.EMPTY_AND_OPTIONAL = new InputState(false, "empty-and-optional", "Optional");
        return InputState;
    })();
    JPVForm.InputState = InputState;
})(JPVForm || (JPVForm = {}));
/// <reference path="../InputBase.ts" />
var JPVForm;
(function (JPVForm) {
    ...
    (function (Input) {
        var PasswordField = (function (_super) {
            ...
            Object.defineProperty(PasswordField.prototype, "htmlElement", {
                get: function () { return this._htmlElement; },
                enumerable: true,
                configurable: true
            });
...
(function (JPVForm) {
    var Tooltip;
    (function (Tooltip) {
        var TooltipAnchor = (function (_super) {
            __extends(TooltipAnchor, _super);
            function TooltipAnchor() {
                _super.call(this, document.createElement("div"));
                this.classes.add("form-tooltip-anchor");
            }
            TooltipAnchor.prototype.append = function (child) {
                _super.prototype.append.call(this, child);
            };
            return TooltipAnchor;
        })(JPV.View.View);
        Tooltip.TooltipAnchor = TooltipAnchor;
    })(Tooltip = JPVForm.Tooltip || (JPVForm.Tooltip = {}));
})(JPVForm || (JPVForm = {}));
/// <reference path="TooltipDescription.ts" />
/// <reference path="TooltipItem.ts" />
var JPVForm;
(function (JPVForm) {
    var Tooltip;
    (function (Tooltip_1) {
        var Tooltip = (function (_super) {
            ...
            function Tooltip(validityItems, description) {
                _super.call(this, document.createElement("div"));
                this.classes.add("form-tooltip");
                this.htmlElement.style.display = "none";
                this.append(this.description = new Tooltip_1.TooltipDescription(description));
                var validatorItemsContainer = new JPV.View.Structure.Container("validators");
                for (var _i = 0, _a = validityItems.filter(function (item) { return !item.filtersValue; }); _i < _a.length; _i++) {
                    var validityItem = _a[_i];
                    var tooltipItem = new Tooltip_1.TooltipItem(validityItem);
                    validatorItemsContainer.append(tooltipItem);
                }
                this.append(validatorItemsContainer);
                var filterItemsContainer = new JPV.View.Structure.Container("filters");
                for (var _b = 0, _c = validityItems.filter(function (item) { return item.filtersValue; }); _b < _c.length; _b++) {
                    var validityItem = _c[_b];
                    var tooltipItem = new Tooltip_1.TooltipItem(validityItem);
                    filterItemsContainer.append(tooltipItem);
                }
                this.append(filterItemsContainer);
            }
            Tooltip.prototype.setDisplayed = function (displayed) {
                this.htmlElement.style.display = displayed ? "" : "none";
            };
            return Tooltip;
        })(JPV.View.View);
...
/// <reference path="tooltip/TooltipAnchor.ts" />
/// <reference path="tooltip/Tooltip.ts" />
var JPVForm;
(function (JPVForm) {
    var Field = (function (_super) {
        __extends(Field, _super);
        function Field(input, description) {
            var _this = this;
            _super.call(this, document.createElement("div"));
            this.tooltipDisabled = false;
            this.classes.add("form-field");
            this.htmlElement.onmouseover = function () { return _this.onMouseOver(); };
            this.htmlElement.onmouseout = function () { return _this.onMouseOut(); };
            this._description = description;
            this.append(this._input = input);
            input.validationChangedEvent.add(this, this.onInputValidationChanged);
            this.append(this.tooltipAnchor = new JPVForm.Tooltip.TooltipAnchor());
            this.initializeTooltip();
        }
        Object.defineProperty(Field.prototype, "input", {
        ...
        Field.prototype.setTooltipDisabled = function (disabled) {
            this.tooltipDisabled = disabled;
        };
        Field.prototype.onInputValidationChanged = function () {
            this.initializeTooltip();
        };
        Field.prototype.onMouseOver = function () {
            this.tooltip.setDisplayed(!this.tooltipDisabled);
        };
        Field.prototype.onMouseOut = function () {
            this.tooltip.setDisplayed(false);
        };
        Field.prototype.initializeTooltip = function () {
            if (this.tooltip != null)
                this.tooltip.dispose();
            this.tooltipAnchor.append(this.tooltip = new JPVForm.Tooltip.Tooltip(this.input.getValidityItems(), this.description));
        };
        return Field;
    })(JPV.View.View);
    JPVForm.Field = Field;
...
(function (JPVForm) {
    var FieldSet = (function (_super) {
        ...
        function FieldSet() {
            _super.call(this, document.createElement("div"));
            this.classes.add("form-field-set");
        }
        FieldSet.prototype.append = function (child) {
            _super.prototype.append.call(this, child);
        };
        return FieldSet;
    })(JPV.View.View);
    JPVForm.FieldSet = FieldSet;
})(JPVForm || (JPVForm = {}));
/// <reference path="FieldSet.ts" />
/// <reference path="FieldRow.ts" />
/// <reference path="FieldLabel.ts" />
/// <reference path="Field.ts" />
var JPVForm;
(function (JPVForm) {
    var FieldSet = JPVForm.FieldSet;
    var FieldRow = JPVForm.FieldRow;
    var Field = JPVForm.Field;
    var FormHelper = (function () {
        function FormHelper() {
        }
        FormHelper.createFieldSets = function (configs) {
            var fieldSets = [];
            for (var _i = 0; _i < configs.length; _i++) {
                var config = configs[_i];
                fieldSets.push(this.createFieldSet(config));
            }
            return fieldSets;
        };
        FormHelper.createFieldSet = function (config) {
            var fieldSet = new FieldSet();
            if (config.fieldSets != undefined) {
                for (var _i = 0, _a = config.fieldSets; _i < _a.length; _i++) {
                    var childConfig = _a[_i];
                    if (childConfig.inputCollection == undefined)
                        childConfig.inputCollection = config.inputCollection;
                    fieldSet.append(this.createFieldSet(childConfig));
                }
            }
            if (config.fields != undefined) {
                for (var _b = 0, _c = config.fields; _b < _c.length; _b++) {
                    var fieldConfig = _c[_b];
                    if (fieldConfig.inputSet == undefined)
                        fieldConfig.inputSet = config.inputCollection;
                    fieldSet.append(this.createFieldRow(fieldConfig));
                }
            }
            return fieldSet;
        };
        FormHelper.createFieldRow = function (config) {
            if (config.description == undefined) {
                config.description = "";
            }
            if (config.required != undefined || config.validators != undefined) {
                var required = (config.required == true);
                var validityItems = [];
                if (config.filters != undefined) {
                    for (var _i = 0, _a = config.filters; _i < _a.length; _i++) {
                        var filter = _a[_i];
                        config.input.validationChain.addSynchroneFilter(filter);
                    }
                }
                if (config.validators != undefined) {
                    for (var _b = 0, _c = config.validators; _b < _c.length; _b++) {
                        var validator = _c[_b];
                        config.input.validationChain.addSynchroneValidator(validator);
                    }
                }
                if (config.asyncValidators != undefined) {
                    for (var _d = 0, _e = config.asyncValidators; _d < _e.length; _d++) {
                        var asyncValidator = _e[_d];
                        validityItems.push(new JPV.Validation.AsynchroneValidatorItem(asyncValidator));
                    }
                }
            }
            var field = new Field(config.input, config.description);
            if (config.hideTooltip != undefined && config.hideTooltip)
                field.setTooltipDisabled(true);
            if (config.inputSet != null)
                config.inputSet.addInput(config.input);
            if (config.value !== undefined)
                config.input.setValue(config.value);
            var row = new FieldRow(field, config.label);
            if (config.hideIcon != undefined && config.hideIcon)
                row.setIconDisabled(true);
            return row;
        };
        return FormHelper;
    })();
    JPVForm.FormHelper = FormHelper;
})(JPVForm || (JPVForm = {}));
/// <reference path="InputState.ts" />
/// <reference path="InputBase.ts" />
/// <reference path="input/StringField.ts" />
/// <reference path="input/TextField.ts" />
/// <reference path="input/EMailAddressField.ts" />
/// <reference path="input/PasswordField.ts" />
/// <reference path="input/NumberField.ts" />
/// <reference path="input/Checkbox.ts" />
/// <reference path="tooltip/TooltipAnchor.ts" />
/// <reference path="tooltip/TooltipItem.ts" />
/// <reference path="tooltip/TooltipDescription.ts" />
/// <reference path="tooltip/Tooltip.ts" />
/// <reference path="Field.ts" />
/// <reference path="FieldLabel.ts" />
/// <reference path="FieldRow.ts" />
/// <reference path="FieldSet.ts" />
/// <reference path="InputCollection.ts" />
/// <reference path="FormHelper.ts" />
var JPV;
(function (JPV) {
    var Event;
    (function (Event) {
...
(function (JPV) {
    ...
    (function (Validation3) {
        ...
        var ValidatorBase = (function () {
            function ValidatorBase(infoText, breakChain) {
                this._infoText = infoText;
                this._breakChain = breakChain;
            }
            Object.defineProperty(ValidatorBase.prototype, "infoText", {
                get: function () { return this._infoText; },
                enumerable: true,
                configurable: true
            });
            Object.defineProperty(ValidatorBase.prototype, "breakChain", {
                get: function () { return this._breakChain; },
                enumerable: true,
                configurable: true
            });
            return ValidatorBase;
        })();
        Validation3.ValidatorBase = ValidatorBase;
    })(Validation3 = JPV.Validation3 || (JPV.Validation3 = {}));
})(JPV || (JPV = {}));
var JPV;
(function (JPV) {
    var View;
...
(function (JPVFormMVC) {
    ...
    (function (Service) {
        var Value;
        (function (Value) {
            var NumberTextConverter = (function () {
                function NumberTextConverter() {
                }
                NumberTextConverter.prototype.convert = function (stringValue) {
                    return parseFloat(stringValue);
                };
                NumberTextConverter.prototype.convertBack = function (value) {
                    return value.toFixed(2);
                };
                return NumberTextConverter;
            })();
            Value.NumberTextConverter = NumberTextConverter;
        })(Value = Service.Value || (Service.Value = {}));
    })(Service = JPVFormMVC.Service || (JPVFormMVC.Service = {}));
})(JPVFormMVC || (JPVFormMVC = {}));
var JPV;
(function (JPV) {
    var Validation3;
    (function (Validation3) {
        ...
        var ValidationResult = (function () {
            function ValidationResult(unfilteredValue, filteredValue, valid) {
                this._unfilteredValue = unfilteredValue;
                this._filteredValue = filteredValue;
                this._valid = valid;
            }
            Object.defineProperty(ValidationResult.prototype, "unfilteredValue", {
                /**
                 * Gets the unfiltered value.
                 */
                get: function () { return this._unfilteredValue; },
                enumerable: true,
                configurable: true
            });
            Object.defineProperty(ValidationResult.prototype, "filteredValue", {
                /**
                 * Gets the filtered value.
                 */
                get: function () { return this._filteredValue; },
                enumerable: true,
                configurable: true
            });
            /**
        ...
        Validation3.ValidationResult = ValidationResult;
    })(Validation3 = JPV.Validation3 || (JPV.Validation3 = {}));
})(JPV || (JPV = {}));
...
(function (JPV) {
    ...
    (function (Validation3) {
         ...
         */
        var ValidationChain = (function () {
            function ValidationChain(filters, validators) {
                this._filters = [];
                this._validators = [];
                this._filters = filters;
                this._validators = validators;
            }
            Object.defineProperty(ValidationChain.prototype, "filters", {
                /**
                 * Gets the filters.
                 */
            ...
            Object.defineProperty(ValidationChain.prototype, "validators", {
                /**
                 * Gets the validators.
                 */
             ...
             */
            ValidationChain.prototype.validate = function (value) {
                ...
                return new Validation3.ValidationResult(value, filteredValue, valid);
            };
            /**
             * Merges this validation chain and the given validation chain.
             * Returns the merged validation chain.
             */
            ValidationChain.prototype.merge = function (validationChain) {
                var filters = this.filters.concat(validationChain.filters);
                var validators = this.validators.concat(validationChain.validators);
                return new ValidationChain(filters, validators);
            };
            return ValidationChain;
        })();
        Validation3.ValidationChain = ValidationChain;
    })(Validation3 = JPV.Validation3 || (JPV.Validation3 = {}));
})(JPV || (JPV = {}));
/// <reference path="../View.ts" />
var JPV;
...
(function (JPVFormMVC) {
    var NumberField = (function () {
        function NumberField() {
            this._valueModel = new JPVFormMVC.Model.Value.TextBasedValueModel();
            this._view = new JPVFormMVC.View.Input("text", this._valueModel);
        }
        Object.defineProperty(NumberField.prototype, "view", {
            get: function () { return this._view; },
            enumerable: true,
            configurable: true
        });
        Object.defineProperty(NumberField.prototype, "valueModel", {
            get: function () { return this._valueModel; },
            enumerable: true,
            configurable: true
        });
        return NumberField;
    })();
    JPVFormMVC.NumberField = NumberField;
})(JPVFormMVC || (JPVFormMVC = {}));
var JPVFormNew;
(function (JPVFormNew) {
    var View;
    (function (View) {
        var TextField = (function () {
            function TextField(type) {
                ...
                this.maxLength = null;
                this._htmlElement = document.createElement("input");
                this._htmlElement.type = type;
                this._htmlElement.oninput = function () { return _this.valueChangedByUser(); };
            }
            Object.defineProperty(TextField.prototype, "htmlElement", {
                get: function () { return this._htmlElement; },
                enumerable: true,
            ...
            TextField.prototype.getAllowedCharacters = function () {
                return this.allowedCharacters;
            };
            TextField.prototype.setAllowedCharacters = function (characters) {
            ...
            TextField.prototype.valueChangedByUser = function () {
                this.valueChangedEvent.trigger(this, null);
            };
            return TextField;
        })();
...
(function (JPV) {
    ...
    (function (Validation3) {
        ...
        Validation3.ValidationError = ValidationError;
    })(Validation3 = JPV.Validation3 || (JPV.Validation3 = {}));
})(JPV || (JPV = {}));
/// <reference path="FilterInterface.ts" />
var JPV;
(function (JPV) {
    ...
    (function (Validation3) {
        ...
        var FilterBase = (function () {
            function FilterBase(infoText) {
                this._infoText = infoText;
            }
            Object.defineProperty(FilterBase.prototype, "infoText", {
                get: function () { return this._infoText; },
                enumerable: true,
                configurable: true
            });
        ...
        Validation3.FilterBase = FilterBase;
    })(Validation3 = JPV.Validation3 || (JPV.Validation3 = {}));
})(JPV || (JPV = {}));
/// <reference path="FilterInterface.ts" />
/// <reference path="ValidatorInterface.ts" />
...
/// <reference path="ValidatorBase.ts" />
/// <reference path="Filter/_references.ts" />
/// <reference path="Validator/_references.ts" />
/// <reference path="ValueModel" />
var JPVFormMVC;
(function (JPVFormMVC) {
    var Model;
    (function (Model) {
        var Value;
        (function (Value) {
            var TextBasedValueModel = (function (_super) {
                __extends(TextBasedValueModel, _super);
                function TextBasedValueModel() {
                    _super.apply(this, arguments);
                    this.userValueChangedEvent = new JPV.Event.Event();
                    this.userValue = "";
                }
                TextBasedValueModel.prototype.getUserValue = function () {
                    return this.userValue;
                };
                TextBasedValueModel.prototype.setUserValue = function (userValue) {
                    if (userValue == this.userValue)
                        return;
                    this.userValue = userValue;
                    this.userValueChangedEvent.trigger(this, null);
                };
                return TextBasedValueModel;
            })(Value.ValueModel);
            Value.TextBasedValueModel = TextBasedValueModel;
        })(Value = Model.Value || (Model.Value = {}));
    })(Model = JPVFormMVC.Model || (JPVFormMVC.Model = {}));
})(JPVFormMVC || (JPVFormMVC = {}));
/// <reference path="../View" />
    ...
    (function (Model) {
        ...
        (function (Validation) {
            var ValidationModel = (function () {
                ...
                ValidationModel.prototype.getValidationItems = function () {
                    return this.validationItems;
                };
                ValidationModel.prototype.setValidationItems = function (validationItems) {
                    this.validationItems = validationItems;
                    this.changedEvent.trigger(this, null);
                };
                ValidationModel.prototype.addValidationItem = function (validationItem) {
                    this.validationItems.push(validationItem);
                    this.changedEvent.trigger(this, null);
                };
                ValidationModel.prototype.getState = function () {
                    return this.state;
                };
                ValidationModel.prototype.setState = function (state) {
                    if (state != this.state) {
                        this.state = state;
                        this.changedEvent.trigger(this, null);
                    }
            ...
            Validation.ValidationModel = ValidationModel;
        })(Validation = Model.Validation || (Model.Validation = {}));
    })(Model = JPVFormMVC.Model || (JPVFormMVC.Model = {}));
})(JPVFormMVC || (JPVFormMVC = {}));
/// <reference path="../View" />
var JPV;
...
(function (JPVFormMVC) {
    ...
    (function (Controller) {
        var Value;
        (function (Value) {
            var TextValueConvertingController = (function () {
                function TextValueConvertingController(model, converter) {
                    this.model = model;
                    this.converter = converter;
                    model.userValueChangedEvent.add(this, this.onUserValueChanged);
                }
                TextValueConvertingController.prototype.onUserValueChanged = function () {
                    var value = this.converter.convert(this.model.getUserValue());
                    this.model.setUnfilteredValue(value);
                };
                return TextValueConvertingController;
            })();
            Value.TextValueConvertingController = TextValueConvertingController;
        })(Value = Controller.Value || (Controller.Value = {}));
    })(Controller = JPVFormMVC.Controller || (JPVFormMVC.Controller = {}));
})(JPVFormMVC || (JPVFormMVC = {}));
var JPVFormMVC;
(function (JPVFormMVC) {
    var View;
    (function (View) {
        var Input = (function () {
            function Input(type, valueModel) {
                var _this = this;
                this._htmlElement = document.createElement("input");
                this._htmlElement.type = type;
                this._htmlElement.oninput = function () { return _this.valueChangedByUser(); };
                this.valueModel = valueModel;
                valueModel.userValueChangedEvent.add(this, this.updateValue);
            }
            ...
            Input.prototype.valueChangedByUser = function () {
                var value = this.htmlElement.value;
                this.valueModel.setUserValue(value);
            };
            Input.prototype.updateValue = function () {
                this.htmlElement.value = this.valueModel.getUserValue();
            };
            return Input;
        })();
        View.Input = Input;
    })(View = JPVFormMVC.View || (JPVFormMVC.View = {}));
})(JPVFormMVC || (JPVFormMVC = {}));
var JPV;
(function (JPV) {
    var Timing;
...
(function (JPVForm) {
    var Form = (function (_super) {
        ...
        function Form(config) {
            ...
            if (config.inputCollection == undefined) {
                config.inputCollection = new JPVForm.InputCollection();
            }
            this._inputCollection = config.inputCollection;
            this.fieldSet = JPVForm.FormHelper.createFieldSet(config);
        }
        Object.defineProperty(Form.prototype, "inputCollection", {
            get: function () { return this._inputCollection; },
            enumerable: true,
            configurable: true
        });
        Form.prototype.isValid = function () {
            return this.inputCollection.isValid();
        };
        return Form;
    })(JPV.View.View);
    JPVForm.Form = Form;
